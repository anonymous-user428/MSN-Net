...
if __name__ == "__main__":
    fpath = "/DKUdata/2020/zhangyc/corpus/raw_data/dcase2023_t2/development/ToyCar/test/section_00_source_test_anomaly_0001_car_B1_spd_31V_mic_1.wav"
    wav_length = 18
    spectrogram, _ = file2spectrogram(fpath, wav_length)
    spectrum, _    = file2spectrum(fpath, wav_length)
